...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        """
        try:
            self.isPositionInRoom(pos)
        except:
            print 'This tile does not exists, really it does not.' 
            
        cleanX = math.floor(pos.x)
        cleanY = math.floor(pos.y)
        
        if (cleanX,cleanY) not in self.cleanTiles:
            self.cleanTiles.append((cleanX,cleanY))
...
showPlot1('The Battle of the bots','Robots','time')
showPlot1('The Battle of the bots','Robots','time')
showPlot2('The Battle of the bots','Robots','time')
showPlot2('The Battle of the bots','Robots','time')